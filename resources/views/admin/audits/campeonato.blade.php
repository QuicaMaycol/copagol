<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Historial de Cambios para Campeonato') }}: {{ $campeonato->nombre_torneo }}
        </h2>
    </x-slot>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">No hay historial de cambios para este campeonato.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
