<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div x-data="{ imagePreview: '{{ $jugador->imagen_path ? asset('storage/' . $jugador->imagen_path) : asset('img/logo.png') }}' }">
                            ...
                            <div class="bg-white rounded-lg shadow-lg p-6">
                                <div class="flex flex-col items-center">
                                    ...
                                    <label for="imagen_jugador" class="cursor-pointer bg-copa-blue-700 text-white text-sm font-bold py-2 px-4 rounded-lg hover:bg-copa-blue-800 transition duration-300">
                                        ...
                                        <input type="file" id="imagen_jugador" name="imagen_jugador" class="hidden" @change="imagePreview = URL.createObjectURL($event.target.files[0])" accept="image/*">
                                    </label>
